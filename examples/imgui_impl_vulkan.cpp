...
//  [x] Renderer: User texture binding uses VkDescriptorSet. See https://github.com/ocornut/imgui/pull/914
...
bool ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
    ...
    io.Fonts->TexID = (ImTextureID)(intptr_t)g_DescriptorSet;
...
static void ImGui_ImplVulkan_CreatePipeline(VkDevice device, const VkAllocationCallbacks* allocator, VkPipelineCache pipelineCache, VkRenderPass renderPass, VkSampleCountFlagBits MSAASamples, VkPipeline* pipeline)
{
    ...
    color_attachment[0].colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT; // NOTE: removed alpha from color write mask to get rid of the windows alpha blending 1px border.
